...
namespace backend.Controllers.Business.BusinessFuncionario
{
    public class VerificarParamentrosBusiness
    {
        ...
        public void ValidarAlteracaonumeroSerie (Models.Request.RequestFuncionario.RequestLivro request )
        {
