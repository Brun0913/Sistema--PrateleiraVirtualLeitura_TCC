...
namespace backend.Models
{
    public partial class TccContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseMySql("host=localhost;user=root;password=12345;database=Tcc", x => x.ServerVersion("8.0.19-mysql"));
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<TbCliente>(entity =>
            {
                ...
                entity.Property(e => e.DtVencimentoCartao)
                    .HasColumnName("dt_vencimento_cartao")
                ...
                entity.Property(e => e.NrCodigoSeguranca).HasColumnName("nr_codigo_seguranca");
