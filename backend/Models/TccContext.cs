...
=======
                    optionsBuilder.UseMySql("server=localhost;user id=bookman;password=Space_2020;database=Tcc", x => x.ServerVersion("8.0.18-mysql"));
>>>>>>> 8a105ec189bc0f6f6fcd3802b5dd3cd4ea79ab40
            }
        }
